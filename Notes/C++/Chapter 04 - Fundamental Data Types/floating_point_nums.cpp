...
// Floating part of the name refers to the fact that the decmal point can "float", ala support a variable number of digits before and after the decimal point.
